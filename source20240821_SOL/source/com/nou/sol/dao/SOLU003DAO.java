...
public class SOLU003DAO extends DAO
{
    ...
    public SOLU003DAO(DBManager dbManager, Connection conn, Hashtable requestMap, HttpSession session) throws Exception
    {
        this();
        this.dbManager    =    dbManager;
        this.conn    =    conn;
    ...
    public SOLU003DAO(DBManager dbManager, Connection conn, Hashtable requestMap, String USER_ID) throws Exception
    {
        this();
        this.dbManager    =    dbManager;
        this.conn    =    conn;
