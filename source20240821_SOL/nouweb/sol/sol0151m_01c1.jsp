...
Author            : barry
Description        : SOL051M_收件資料登錄審查 - 控制頁面 (javascript)
Modification Log    :
...
/** 初始設定頁面資訊 */
var    printPage        =    "/sol/sol0151m_01p1.jsp";    //列印頁面
...
var    controlPage        =    "/sol/sol0151m_01c2.jsp";    //控制頁面
...
//    Form.iniFormSet('EDIT', 'GETINFO', 'AA', 'chkForm', '獲得空大招生來源');
    ...
    Form.iniFormSet('EDIT', 'EMRGNCY_NAME', 'M', 10, 'S', 10, 'AA', 'chkForm', '緊急聯絡人');
    Form.iniFormSet('EDIT', 'EMRGNCY_TEL','M',  17, 'AA', 'chkForm', '緊急聯絡人電話');
    Form.iniFormSet('EDIT', 'EMRGNCY_RELATION', 'M', 10, 'S', 10, 'AA', 'chkForm', '緊急聯絡人關係');
    Form.iniFormSet('EDIT', 'EMRGNCY_EMAIL', 'AA', 'chkForm', '緊急聯絡人電子信箱');
...
function addr()
{
	...
	if(_i('EDIT','CRRSADDR').value == "" || tmp.length <= 6)
		Form.openPhraseWindow("SOL015M_01_WINDOW", null, null, "郵遞區號, 縣市鄉鎮區", [_i("EDIT", "CRRSADDR_ZIP"), _i("EDIT", "CRRSADDR")]);
	else
		Form.openPhraseWindow("SOL015M_01_WINDOW", null, null, "郵遞區號, 縣市鄉鎮區", [_i("EDIT", "CRRSADDR_ZIP"), _i("EDIT", "CRRSADDR2")]);
}
...
function addr_d()
{
	...
	if(_i('EDIT','DMSTADDR').value == "" || tmp.length <= 6)
		Form.openPhraseWindow("SOL015M_02_WINDOW", null, null, "郵遞區號, 縣市鄉鎮區", [_i("EDIT", "DMSTADDR_ZIP"), _i("EDIT", "DMSTADDR")]);
	else
		Form.openPhraseWindow("SOL015M_02_WINDOW", null, null, "郵遞區號, 縣市鄉鎮區", [_i("EDIT", "DMSTADDR_ZIP"), _i("EDIT", "DMSTADDR2")]);
}
